...
public class StatisticsController{
	...
	StatisticsController(final MessageRepository messageRepository, final AnnouncementService announcementService){
	...
	public ModelAndView subscriptions(final @PageableDefault(size=9) Pageable pageable){
		...
		Page<User> list=announcementService.getUsersWithSubscriptions(pageable);
