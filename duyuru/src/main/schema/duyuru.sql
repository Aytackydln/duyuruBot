...
VALUES ('en', 'CANCEL', 'Cancel'),
       ...
       ('en', 'SUBSCRIBE_LIST_HEADER', 'Choose the topicEntity to subscribe'),
       ...
       ('en', 'TOPIC_NOT_EXISTS',
        'topicEntity does not exists orcould not be parsed because of its name. You will be subscribed manually later.'),
       ...
       ('en', 'UNSUBSCRIBE_LIST_HEADER', 'Choose the topicEntity to unsubscribe'),
       ('en', 'UNSUBSCRIBE_SUCCESS', 'you are now unsubscribed'),
       ('en', 'WELCOME',
        'Hello, you can send me commands by pressing the  /  button below.  Example commands are:\r\n/list - shows your subscriptions\r\n/subscribe - opens menu to subscribe topicEntities\r\n/unsubscribe - removes selected subscriptionEntity\r\nNote: If you are the first subscriber of a topicEntity you will get notifications of all the announcementEntities of that topicEntity for one time only.'),
       ('tr', 'CANCEL', 'İptal'),
